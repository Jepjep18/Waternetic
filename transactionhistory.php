    ...
    <script>
        function calculateWaterConsumption() {
            ...
            if (!isNaN(previousReading) && !isNaN(currentReading)) {
                var totalWaterConsumption = currentReading - previousReading;
...
<body>
    ...
    <div class="table-responsive table-billing-history">
        <table class="table mb-0">
            <thead>
                <tr>
                    <th class="border-gray-200" scope="col">Bill Type</th>
                    <th class="border-gray-200" scope="col">First Name</th>
                    <th class="border-gray-200" scope="col">Last Name</th>
                    <th class="border-gray-200" scope="col">Amount</th>
                    <th class="border-gray-200" scope="col">Timestamp</th>
                </tr>
            </thead>
            <tbody>
                <?php
                $sql = "SELECT customer_id, bill_type, firstname, lastname, amount, real_timestamp, status FROM payment_services WHERE customer_id='" . $_SESSION['session_id'] . "' ";
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        // Format amount with comma and peso sign
                    ...
                    echo "<tr><td colspan='5'>No billing history found.</td></tr>";
                }
                ?>
            </tbody>
        </table>
