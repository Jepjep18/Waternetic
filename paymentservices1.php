...
// Retrieve total_due from statement_of_account table
$statement_query = "SELECT total_due FROM statement_of_account WHERE user_id = ?";
$statement_stmt = $conn->prepare($statement_query);
$statement_stmt->bind_param("i", $_SESSION['session_id']);
$statement_stmt->execute();
$statement_result = $statement_stmt->get_result();
