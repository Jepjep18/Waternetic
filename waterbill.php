            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="firstName" name="firstName" class="form-control"
                           value="<?php echo $row_user['firstname']; ?>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="middleName" name="middleName" class="form-control"
                           value="<?php echo $row_user['middlename']; ?>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="lastName" name="lastName" class="form-control"
                           value="<?php echo $row_user['lastname']; ?>" readonly>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="block" name="block" class="form-control"
                           value="<?php echo $row_user['block']; ?>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="lot" name="lot" class="form-control"
                           value="<?php echo $row_user['lot']; ?>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="phase" name="phase" class="form-control"
                           value="<?php echo $row_user['phase']; ?>" readonly>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="previous_reading">Previous Reading (in gallons):</label>
                    <input type="number" id="previous_reading" name="previous_reading" class="form-control"
                           value="<?php echo $previousReading; ?>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="previous_reading_date">Previous Reading Date:</label>
                    <input type="text" id="previous_reading_date" name="previous_reading_date" class="form-control"
                           value="<?php echo $previousReadingDate; ?>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="present_reading">Present Reading (in gallons):</label>
